...
- [Element&nbsp;arguments](#element-arguments)
  - [TCA arguments](#user-content-tca-arguments)
&bull; [TCC-early arguments](#user-content-tcc-early-arguments)
&bull; [TCC arguments](#user-content-tcc-arguments)
&bull; [TCC-625 arguments](#user-content-tcc-625-arguments)
&bull; [TCD-early arguments](#user-content-tcd-early-arguments)
&bull; [TCD-improved arguments](#user-content-tcd-improved-arguments)
&bull; [TCE arguments](#user-content-tce-arguments)
&bull; [TCF-early arguments](#user-content-tcf-early-arguments)
&bull; [TCF-optical arguments](#user-content-tcf-optical-arguments)
&bull; [TCF-electronic arguments](#user-content-tcf-electronic-arguments)
...
- [Video&nbsp;generation](#video-generation)
  - [Static&nbsp;test&nbsp;cards](#static-test-cards)
...
see for instance the [`TCC`](#user-content-tcc-arguments) set.
...
with a transparent hole where the image should be (see [arguments](#user-content-tcf-optical-arguments))
...
Names are hyphenated as *pattern-variant* which controls compositing and drawing algorithms.
...
When making a new pattern, add it to the `groups` dictionary in [tcm-init.ps](Resource/ProcSet/tcm-init.ps).
...
<details><summary><code>TCA</code> arguments</summary>
<a name='tca-arguments'></a>

</details>

<details><summary><code>TCC-early</code> arguments</summary>
<a name='tcc-early-arguments'></a>

Inheritance: `TCC-early` <— [`Blank`](#user-content-blank-arguments)
...
<details><summary><code>TCC</code> arguments</summary>
<a name='tcc-arguments'></a>
...
<details><summary><code>TCC-625</code> arguments</summary>
<a name='tcc-625-arguments'></a>

Inheritance: `TCC-625` <— [`TCC`](#user-content-tcc-arguments) <— [`TCC-early`](#user-content-tcc-early-arguments) <— [`Blank`](#user-content-blank-arguments)
| arg | value | description |
| ---: | :---: | :--- |
| ***/TC…*** |  | ***test card arguments*** |
...
<details><summary><code>TCD-early</code> arguments</summary>
<a name='tcd-early-arguments'></a>
...
<details><summary><code>TCD-improved</code> arguments</summary>
<a name='tcd-improved-arguments'></a>
...
<details><summary><code>TCE</code> arguments</summary>
<a name='tce-arguments'></a>

Inheritance: `TCE` <— [`TCD-early`](#user-content-tcd-early-arguments) <— [`TCC-early`](#user-content-tcc-early-arguments) <— [`Blank`](#user-content-blank-arguments)
| arg | value | description |
| ---: | :---: | :--- |
| ***/TC…*** |  | ***test card arguments*** |
...
<details><summary><code>TCF-early</code> arguments</summary>
<a name='tcf-early-arguments'></a>
...
<a name='tcf-optical-arguments'></a>
...
<details><summary><code>TCF-electronic</code> arguments</summary>
<a name='tcf-electronic-arguments'></a>
...
Here is a 1965-themed example to illustrate the concept (click to enlarge).
It is created from the arguments below extracted from the [args file](assets/ce/ce-example.ps) used.
...
- `I2`(magenta Art Nouveau): transparent EPS, drawn in quadrant Q2 but painted in all quadrants
...
- `T10` (block-inverted caption): rounded blocks and background, justified and padded
...
<img src='assets/ce/quadrants.png' alt='Quadrants' align='left'>
...
<img src='assets/ce/Rotation_of_Reuleaux_triangle.gif' alt='Reuleaux triangle' align='right'>
...
> For *TCA*, which has no graticule, `Gsz` is the distance between adjacent horizontal castellation midpoints clamped within ±10% of the vertical ones.
...
![PS fonts](assets/fonts/ps-fonts.png)
...
TCM block-inverts Derek AT Italic for *TCC-625* and *TCD*, and Washington Book for *TCF-optical*,
as they match closest in overlay tests.

Other fonts are easier to identify, e.g. Gill Sans, Helvetica.
Sanchez is used for the *TCF-electronic* ID.
...
include [`palettegen`](https://www.ffmpeg.org/ffmpeg-filters.html#palettegen) and [`paletteuse`](https://www.ffmpeg.org/ffmpeg-filters.html#paletteuse) in the filtergraph:
...
The animation above actually uses other [ffmpeg filters](https://www.ffmpeg.org/ffmpeg-filters.html#) too and different encodings:
...
- [`zscale`](https://www.ffmpeg.org/ffmpeg-filters.html#zscale) to `504*260/768` height reduces the video to double the centre circle radius `CCr` for the GIF width 504
...
![Television Servicing Handbook](assets/gjk/Television-Servicing-Handbook-ed2-thumb.png) &nbsp;
![Colour Television Servicing](assets/gjk/Colour-Television-Servicing-ed3-thumb.png) &nbsp;
